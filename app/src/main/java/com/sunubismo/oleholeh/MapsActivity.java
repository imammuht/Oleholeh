...
import com.sunubismo.oleholeh.helper.DataParser;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    private String getUrl(LatLng origin, LatLng dest) {
        String APIKey = "AIzaSyDmp1vavKnyT9mt0TGnaG_w6LvRha8ruP0";
        // Origin of route
    ...
    public void onLocationChanged(Location location) {
        ...
        MarkerOptions markerToko = new MarkerOptions();
        markerUser.position(latLng)
                .title("Posisi Pengguna")
                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA));
        markerToko.position(dest)
                .title("Posisi Toko")
                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA));
        mCurrLocationMarker = mMap.addMarker(markerUser);
        mMap.addMarker(markerToko);
